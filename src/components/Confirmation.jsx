...
function Confirmation() {
  ...
  return (
    ...
    <div className='w-full tablet:aspect-square aspect-[1/1.2] flex flex-col items-center justify-center'>
        ...
        <img className='tablet:mb-[1.5dvw] mb-[4dvw] tablet:w-fit w-[16dvw]' src="/assets/images/icon-thank-you.svg" alt="img" onLoad={loadIMG}/>
      
        
     {

     iconThankYou &&  <><h1 className='tablet:mb-[0.5dvw] mb-[1.5dvw]'>Thank you!</h1>
